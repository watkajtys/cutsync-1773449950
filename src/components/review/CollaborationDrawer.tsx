...
export const CollaborationDrawer: React.FC = () => {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 border-t border-white/10 transform translate-y-[calc(100%-48px)] hover:translate-y-0 transition-transform duration-500 ease-in-out z-40 bg-white/5 backdrop-blur-md">
